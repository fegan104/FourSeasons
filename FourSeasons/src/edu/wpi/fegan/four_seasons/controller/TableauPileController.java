 ...
 */
public class TableauPileController extends java.awt.event.MouseAdapter {
    /**
     ...
     */
    public TableauPileController(FourSeasons theGame, PileView pv) {
        super();
